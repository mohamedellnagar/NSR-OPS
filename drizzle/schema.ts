...
export const monthlyStockSnapshots = mysqlTable(
  "monthly_stock_snapshots",
  {
    ...
    // KPI snapshot — frozen at close time
    totalSales: decimal("totalSales", { precision: 14, scale: 3 }),
    totalOpEx: decimal("totalOpEx", { precision: 14, scale: 3 }),
    totalMainEx: decimal("totalMainEx", { precision: 14, scale: 3 }),
    totalFixedEx: decimal("totalFixedEx", { precision: 14, scale: 3 }),
    opPaid: decimal("opPaid", { precision: 14, scale: 3 }),
    opDeferred: decimal("opDeferred", { precision: 14, scale: 3 }),
    cogsValue: decimal("cogsValue", { precision: 14, scale: 3 }),
    grossProfit: decimal("grossProfit", { precision: 14, scale: 3 }),
    netProfit: decimal("netProfit", { precision: 14, scale: 3 }),
    openingStockValue: decimal("openingStockValue", { precision: 14, scale: 3 }),
